...
import { getUserFriendlyErrorMessage } from '@/lib/errors/errorTypes';
...
const Alert: React.FC<AlertProps> = ({
  ...
  const processedMessage = error ? getUserFriendlyErrorMessage(error) : message;
  
  // Auto-hide if duration provided
  useEffect(() => {
  ...
  return (
    <div
      className={`border rounded-md p-4 mb-4 ${styles.container} ${className}`}
      role="alert"
      aria-live="assertive"
    >
        ...
        {dismissible && (
          <div className="ml-auto pl-3">
            <div className="-mx-1.5 -my-1.5">
              <button
                type="button"
                className={`inline-flex rounded-md p-1.5 ${styles.closeButton} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500`}
